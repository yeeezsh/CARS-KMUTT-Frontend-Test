...
// interfaces
import TimeNodeSport from './timetable-sport.interface';
...
const cardStyle = (type: TimeNodeSport['type']): React.CSSProperties => {
  switch (type) {
    case 'disabled':
      return disabled;
    case 'selecting':
...
export default class TimeTableSport extends Component<
  TimeTableSportProps,
  TimeTableSportState
> {
  constructor(props: TimeTableSportProps) {
    super(props);
    this.state = {
      table: [],
    };
